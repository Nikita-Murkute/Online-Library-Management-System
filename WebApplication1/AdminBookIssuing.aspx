            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100px" src="Imgs/download.jpg" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col-6">
                        <asp:Button ID="Button2" class="btn btn-lg w-100 btn-primary" runat="server" OnClick="Button2_Click" Text="Issue" />
                     </div>
                     <div class="col-6">
                        <asp:Button ID="Button4" class="btn btn-lg w-100 btn-success" runat="server" OnClick="Button4_Click" Text="Return" />
                     </div>
                  </div>
               </div>
            </div>
